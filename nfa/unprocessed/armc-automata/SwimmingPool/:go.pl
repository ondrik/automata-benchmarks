...
abstr_fw(Conc,Abstr) :-
  ...
  Conc=fa(ConcSym,_,ConcIniL,ConcFinL,ConcTrL,_),
    ...
    ConcIniL=[ConcIni],
    ini_partition_mod_n(9,ConcIni,ConcTrL,IniClsL),
    ini_fw_classes_mod_n(IniClsL),
...
fl_comp_partition(N,QN,FL,TrL,PartL) :-
  sigma(SigL),
    ...
    ini_partition_mod_n(9,0,TrL,IniClsL1),
...
do_comp_ini_partition_mod_n(Q1,N,ToDoL,DoneL,[trans(Q1,_,Q2)|TrL],NewToDoL,NewDoneL) :-
  ( (member([Q2,_],DoneL), !,
    ...
    do_comp_ini_partition_mod_n(Q1,N,[[Q2,N]|ToDoL],[[Q2,N]|DoneL],TrL,NewToDoL,NewDoneL) ),
  !.
...
collect_ini_partition_mod_n(N,Mod,ReachL,[[N,CollectedL]|IniClsL]) :-
   N<Mod,
   !,
   do_collect_ini_partition_mod_n(N,ReachL,UnusedL,CollectedL),
   NN is N+1,
...
ini_partition_mod_n(Mod,Q0,TrL,IniClsL) :-
  comp_ini_partition_mod_n(Mod,[[Q0,0]],[[Q0,0]],TrL,ReachL),
  collect_ini_partition_mod_n(0,Mod,ReachL,IniClsL),
  !.
...
ft_comp_partition(N,QN,TrL,PartL) :-
  sigma(SigL),
    ...
    ini_partition_mod_n(9,0,TrL,IniClsL),
...
abstr_fl_refby_ft(Conc,Abstr) :-
  ...
  sigma(SigL),
    ...
    ini_partition_mod_n(9,0,ConcTrL,IniClsL1),
    split_ini_part_mod_n_fin_nonfin(IniClsL1,FL,_,IniClsL),
...
:- fsa_regex_compile(file(init4),Init),assertz(init(Init)).
...
:- init(Init),bad(Bad),assertz(pred_lang([Init,Bad])).
