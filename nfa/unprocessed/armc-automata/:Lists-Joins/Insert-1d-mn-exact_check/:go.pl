...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% The main loop of accelerating via unwound general loops
% !!! Adding a special state with the new loop !!!
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
:- sort([!,#,'_old','_bgn','_fst','_snd','_end','_ins',l,x,y,z,'_f','_t',n,e,s,su,u,/,'|',l1,l2,l3,l4,l5,l6,l7,l8,le1,le2,m_f,m_t,n_f,n_t],S),assertz(sigma(S)).
%%%%%%%%%%%%%%%%%%%%%%%%
