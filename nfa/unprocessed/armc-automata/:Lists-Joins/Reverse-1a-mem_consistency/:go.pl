...
do_accel_unwound_self_loops(St,StN,UnwoundTimes,/,TrL,[trans(X,/,X)|NewTrL],1) :-
  successor_via_ntimes_a_letter(UnwoundTimes,St,/,TrL,[St],Visited),
  ( (UnwoundTimes=1, !, X=St);
     %% (successor_via_letter(St,/,TrL,X)) ),
     (Visited=[_,X|_]) ),
     %% (Visited=[X|_]) ),
  write('!!! Adding a self-loop at:'),write(X),write(' !!!'),nl,
  NextSt is St+1,
  do_accel_unwound_self_loops(NextSt,StN,UnwoundTimes,/,TrL,NewTrL,_),
  !.

do_accel_unwound_self_loops(St,StN,UnwoundTimes,/,TrL,NewTrL,AccDone) :-
  NextSt is St+1,
  do_accel_unwound_self_loops(NextSt,StN,UnwoundTimes,/,TrL,NewTrL,AccDone).
...
accel_unwound_self_loops(/,States,AccelStates) :-
  ...
  do_accel_unwound_self_loops(0,StN,UnwoundTimes,/,TrL,NewTrL,AccDone),
...
aut_loop_det(DtSymL,SepSym,States,AccelStates) :-
  ...
  MaxLoopLen is MaxCollSeqLen//1,
  ( (MaxLoopLen>0,
     !,
     do_aut_loop_det(1,MaxLoopLen,1,DtSymL,SepSym,StN,TrL,StN,NewStN,NewTrL,0,AccDone),
     ( (AccDone=0, !, AccelStates=States);
       (fsa_regex_compile(mh(cleanup(fa(fa(PredModule,NewStN,IniL,FinL,NewTrL,[])))),AccelStates)) ));
    (AccelStates=States) ),
  !.
...
do_aut_loop_det(LoopLen1,MaxLoopLen,1,DtSymL,SepSym,StN,TrL,NewStN1,NewStN3,NewTrL3,Acc1,Acc3) :-
  LoopLen1 =< MaxLoopLen,
  !,
  write('Autodetecting loops of length '),write(LoopLen1),
    write(' repeated '),write(1),write(' times. '),nl,



  aut_loop_det_iter_states(0,StN,LoopLen1,TrL,DtSymL,SepSym,NewStN1,NewStN2,NewTrL1,Acc1,Acc2),
  LoopLen2 is LoopLen1+1,
  do_aut_loop_det(LoopLen2,MaxLoopLen,1,DtSymL,SepSym,StN,TrL,NewStN2,NewStN3,NewTrL2,Acc2,Acc3),
  append(NewTrL1,NewTrL2,NewTrL3),
  !.
...
dt_aut_loop_det(DtSymL,States,AccelStates) :-
  ...
  ( (MaxLoopLen>0,
    %% (MaxLoopLen>MinLoopLen,
     !,
     %% dt_do_aut_loop_det(1,MaxLoopLen,1,DtSymL,StN,TrL,StN,NewStN,NewTrL,0,AccDone),
     dt_do_aut_loop_det(2,MaxLoopLen,1,DtSymL,StN,TrL,StN,NewStN,NewTrL,0,AccDone),
     %% dt_do_aut_loop_det(MaxLoopLen,MaxLoopLen,1,DtSymL,StN,TrL,StN,NewStN,NewTrL,0,AccDone),
     %% dt_do_aut_loop_det(MinLoopLen,MaxLoopLen,1,DtSymL,StN,TrL,StN,NewStN,NewTrL,0,AccDone),
     ( (AccDone=0, !, AccelStates=States);
       (fsa_regex_compile(mh(cleanup(fa(fa(PredModule,NewStN,IniL,FinL,NewTrL,[])))),AccelStates)) ));
    (AccelStates=States) ),
  !.
...
dt_do_aut_loop_det(LoopLen1,MaxLoopLen,1,DtSymL,StN,TrL,NewStN1,NewStN3,NewTrL3,Acc1,Acc3) :-
  LoopLen1 =< MaxLoopLen,
  !,
  write('Autodetecting loops of length '),write(LoopLen1),
    write(' repeated '),write(1),write(' times. '),nl,
  ...
  LoopLen2 is LoopLen1+1,
  dt_do_aut_loop_det(LoopLen2,MaxLoopLen,1,DtSymL,StN,TrL,NewStN2,NewStN3,NewTrL2,Acc2,Acc3),
  append(NewTrL1,NewTrL2,NewTrL3),
  !.
...
:- sort([/,'|',!,#,'_f','_t',n,e,su,s,u,l,x,y,l1,l2,l3,l4,l5,l6,l7,l8,m_f,m_t],S),assertz(sigma(S)).
%%%%%%%%%%%%%%%%%%%%%%%%
