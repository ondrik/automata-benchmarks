...
accel_several_unwound_loops([[lte,/],[gt,/]],States,MinAccelStates) :-
  do_accel_several_unwound_loops([[lte,/],[gt,/]],States,AccelStates),
...
abstract(State,AbsState) :- accel_several_unwound_loops([[lte,/],[gt,/]],State,AbsState).
