...
do_save_sigma([A|SL]) :-
  ...
  write(':1 '),
  do_save_sigma(SL).
do_save_sigma([]) :- write('x_init:0'). % The 'initial' letter.
save_sigma :-
  write('Ops '),
  sigma(SL),
  do_save_sigma(SL),
...
save_single_trans(Q1,A,Q2) :-
  write(A), write('(q'),write(Q1),write(') -> q'),write(Q2),nl,
  nl.
%...............................................................................
do_save_trans(Q1,[],Q2) :- !.
...
do_one_run(N,AbsReach,Result,Value) :-
  ...
  write('Abstract source automaton: '),write(NS1),write(','),write(NT1),nl,
      ...
      fsa_regex_compile(cleanup(fa(NewReachNFA)),NewReach),
  ...
  ( (SubResult=good, !,Result=SubResult,Value=SubValue);
    ...
    (itr(ITR),
     ...
     write('Computing pre...'),nl,
         ...
         fsa_regex_compile(cleanup(fa(SrcBad1)),SrcBad),
