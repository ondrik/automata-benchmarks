...
:- retract(tr(TrL)),
   ...
   assertz(tr([[l1,[[l2,L1L1_2]]]|TrL])).

:- retract(tr(TrL)),
   fsa_regex_compile(file(line2_to_line2_7),L2L2_7),
   fsa_regex_compile(file(line2_to_line3),L2L3),
   assertz(tr([[l2,[[l7,L2L2_7],[l3,L2L3]]]|TrL])).
...
:- retract(tr(TrL)),
   fsa_regex_compile(file(line4_to_line4),L4L4),
   fsa_regex_compile(file(line4_to_line5),L4L5),
   assertz(tr([[l4,[[l4,L4L4],[l5,L4L5]]]|TrL])).

:- retract(tr(TrL)),
   fsa_regex_compile(file(line5_to_line5_6),L5L5_6),
   assertz(tr([[l5,[[l6,L5L5_6]]]|TrL])).

:- retract(tr(TrL)),
   fsa_regex_compile(file(line6_to_line6_2),L6L6_2),
   assertz(tr([[l6,[[l2,L6L6_2]]]|TrL])).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file(pr_bgn),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file(pr_fst),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file(pr_snd),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file(pr_end),P),assertz(pred_lang([P|PL])).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file('good-empty'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('good-morethan_two_elms_bgn'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('good-morethan_two_elms_end'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('good-morethan_two_elms_mid'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('good-one_elm'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('good-two_elms'),P),assertz(pred_lang([P|PL])).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file('init-empty'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('init-morethan_two_elms_bgn'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('init-morethan_two_elms_end'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('init-morethan_two_elms_mid'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('init-one_elm'),P),assertz(pred_lang([P|PL])).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file('reachable_not_end_with_bgn'),P),assertz(pred_lang([P|PL])).

:- retract(pred_lang(PL)),fsa_regex_compile(file('reachable_not_start_with_end'),P),assertz(pred_lang([P|PL])).
