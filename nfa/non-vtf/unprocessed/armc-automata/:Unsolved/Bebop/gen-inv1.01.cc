...
int main(int argc,char *argv[]) {
  ...
  cout << (n-1)*5+2+5+1 << ", % number of states\n\n";
  ...
  for (int i=n;i>0;i--) {
    ...
    cout << "trans(0,in(['0','1'])," << (n-i)*5+2 << "),\n";
    
    cout << "trans(" << (n-i)*5+2 << ",in([a,b,c,d,e,f])," << (n-i)*5+2+1 << "),\n";
    
    cout << "trans(" << (n-i)*5+2+1 << ",'" << i << "'," << (n-i)*5+2+2 << "),\n";

    cout << "trans(" << (n-i)*5+2+2 << ",in(['0','1'])," << (n-i)*5+2+3 << "),\n";

    cout << "trans(" << (n-i)*5+2+3 << ",in(['0','1'])," << (n-i)*5+2+4 << "),\n";

    cout << "trans(" << (n-i)*5+2+4 << ",in(['0','1'])," << (n-i)*5+2+5 << "),\n\n";
  ...
  cout << "trans(" << (n-1)*5+2+5 << ",in([p,q,r,s,t]),1)\n\n";
