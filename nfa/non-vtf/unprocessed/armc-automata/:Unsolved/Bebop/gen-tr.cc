...
int main(int argc,char *argv[]) {
  ...
  for (int i=1;i<n;i++) {
    ...
    cout << "trans(" << 48*(i-1)+3 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+4 << "),\n";
    cout << "trans(" << 48*(i-1)+4 << ",in(['0','1'])/'0'," << 48*(i-1)+5 << "),\n";
    cout << "trans(" << 48*(i-1)+5 << ",in(['0','1'])/'0'," << 48*(i-1)+6 << "),\n";
    cout << "trans(" << 48*(i-1)+6 << ",in(['0','1'])/'0'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+7 << "),\n";  	  
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+7 << "),\n";  	  
    cout << "trans(" << 48*(i-1)+7 << ",b/c," << 48*(i-1)+8 << "),\n";
    cout << "trans(" << 48*(i-1)+8 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+9 << "),\n";
    ...
    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+12 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+12 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+12 << ",c/b," << 48*(i-1)+13 << "),\n";
    cout << "trans(" << 48*(i-1)+13 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+14 << "),\n";
    cout << "trans(" << 48*(i-1)+14 << ",'0'/'1'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+15 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+15 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+15 << ",c/b," << 48*(i-1)+16 << "),\n";
    cout << "trans(" << 48*(i-1)+16 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+17 << "),\n";
    cout << "trans(" << 48*(i-1)+17 << ",'1'/'0'," << 48*(i-1)+18 << "),\n";
    cout << "trans(" << 48*(i-1)+18 << ",'0'/'1'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+19 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+19 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+19 << ",c/b," << 48*(i-1)+20 << "),\n";
    cout << "trans(" << 48*(i-1)+20 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+21 << "),\n";
    cout << "trans(" << 48*(i-1)+21 << ",'1'/'0'," << 48*(i-1)+22 << "),\n";
    cout << "trans(" << 48*(i-1)+22 << ",'1'/'0'," << 48*(i-1)+23 << "),\n";
    cout << "trans(" << 48*(i-1)+23 << ",'0'/'1'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+24 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+24 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+24 << ",b/e," << 48*(i-1)+25 << "),\n";
    cout << "trans(" << 48*(i-1)+25 << ",'" << i << "'/'" << i << "'," << 48*(i-1)+26 << "),\n";
    ...
    cout << "trans(" << 48*(i-1)+30 << ",[]/'" << i+1 << "'," << 48*(i-1)+31 << "),\n";
    ...
    cout << "trans(" << 48*(i-1)+35 << ",'" << i << "'/'" << i << "'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+36 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+36 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+36 << ",[]/a," << 48*(i-1)+37 << "),\n";
    cout << "trans(" << 48*(i-1)+37 << ",[]/'" << i+1 << "'," << 48*(i-1)+38 << "),\n";
    ...
    cout << "trans(" << 48*(i-1)+42 << ",'" << i << "'/'" << i << "'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'1'," << 48*(i-1)+43 << "),\n";
    cout << "trans(" << 0 << ",'1'/'0'," << 48*(i-1)+43 << "),\n";
    cout << "trans(" << 48*(i-1)+43 << ",e/f," << 48*(i-1)+44 << "),\n";
    cout << "trans(" << 48*(i-1)+44 << ",'" << i << "'/'" << i << "'," << 1 << "),\n\n";

    cout << "trans(" << 0 << ",'0'/'0'," << 48*(i-1)+45 << "),\n"; 	   
    cout << "trans(" << 0 << ",'1'/'1'," << 48*(i-1)+45 << "),\n"; 	   
    cout << "trans(" << 48*(i-1)+45 << ",f/[]," << 48*(i-1)+46 << "),\n";
    cout << "trans(" << 48*(i-1)+46 << ",'" << i << "'/[]," << 48*(i-1)+47 << "),\n";
    cout << "trans(" << 48*(i-1)+47 << ",in(['0','1'])/[]," << 48*(i-1)+48 << "),\n";
    cout << "trans(" << 48*(i-1)+48 << ",in(['0','1'])/[]," << 48*(i-1)+49 << "),\n";
    cout << "trans(" << 48*(i-1)+49 << ",in(['0','1'])/[]," << 1 << "),\n\n";
  ...
  cout << "trans(" << 48*n-96+51 << ",'" << n << "'/'" << n << "'," << 48*n-96+52 << "),\n";
  cout << "trans(" << 48*n-96+52 << ",in(['0','1'])/'0'," << 48*n-96+53 << "),\n";
  cout << "trans(" << 48*n-96+53 << ",in(['0','1'])/'0'," << 48*n-96+54 << "),\n";
  cout << "trans(" << 48*n-96+54 << ",in(['0','1'])/'0'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+55 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+55 << "),\n";
  cout << "trans(" << 48*n-96+55 << ",b/c," << 48*n-96+56 << "),\n";
  cout << "trans(" << 48*n-96+56 << ",'" << n << "'/'" << n << "'," << 48*n-96+57 << "),\n";
  ...
  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+60 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+60 << "),\n";
  cout << "trans(" << 48*n-96+60 << ",c/b," << 48*n-96+61 << "),\n";
  cout << "trans(" << 48*n-96+61 << ",'" << n << "'/'" << n << "'," << 48*n-96+62 << "),\n";
  cout << "trans(" << 48*n-96+62 << ",'0'/'1'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+63 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+63 << "),\n";
  cout << "trans(" << 48*n-96+63 << ",c/b," << 48*n-96+64 << "),\n";
  cout << "trans(" << 48*n-96+64 << ",'" << n << "'/'" << n << "'," << 48*n-96+65 << "),\n";
  cout << "trans(" << 48*n-96+65 << ",'1'/'0'," << 48*n-96+66 << "),\n";
  cout << "trans(" << 48*n-96+66 << ",'0'/'1'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+67 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+67 << "),\n";
  cout << "trans(" << 48*n-96+67 << ",c/b," << 48*n-96+68 << "),\n";
  cout << "trans(" << 48*n-96+68 << ",'" << n << "'/'" << n << "'," << 48*n-96+69 << "),\n";
  cout << "trans(" << 48*n-96+69 << ",'1'/'0'," << 48*n-96+70 << "),\n";
  cout << "trans(" << 48*n-96+70 << ",'1'/'0'," << 48*n-96+71 << "),\n";
  cout << "trans(" << 48*n-96+71 << ",'0'/'1'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+72 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+72 << "),\n";
  cout << "trans(" << 48*n-96+72 << ",b/e," << 48*n-96+73 << "),\n";
  cout << "trans(" << 48*n-96+73 << ",'" << n << "'/'" << n << "'," << 48*n-96+74 << "),\n";
  ...
  cout << "trans(" << 48*n-96+78 << ",'" << n << "'/'" << n << "'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+79 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+79 << "),\n";
  cout << "trans(" << 48*n-96+79 << ",d/e," << 48*n-96+80 << "),\n";
  cout << "trans(" << 48*n-96+80 << ",'" << n << "'/'" << n << "'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'1'," << 48*n-96+81 << "),\n";
  cout << "trans(" << 0 << ",'1'/'0'," << 48*n-96+81 << "),\n";
  cout << "trans(" << 48*n-96+81 << ",e/f," << 48*n-96+82 << "),\n";
  cout << "trans(" << 48*n-96+82 << ",'" << n << "'/'" << n << "'," << 1 << "),\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+83 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+83 << "),\n";
  cout << "trans(" << 48*n-96+83 << ",f/[]," << 48*n-96+84 << "),\n";
  cout << "trans(" << 48*n-96+84 << ",'" << n << "'/[]," << 48*n-96+85 << "),\n";
  cout << "trans(" << 48*n-96+85 << ",in(['0','1'])/[]," << 48*n-96+86 << "),\n";
  cout << "trans(" << 48*n-96+86 << ",in(['0','1'])/[]," << 48*n-96+87 << "),\n";
  cout << "trans(" << 48*n-96+87 << ",in(['0','1'])/[]," << 1 << "),\n\n";

  cout << "%%%%%%% MAIN\n\n";

  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+88 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+88 << "),\n";
  ...
  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+94 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+94 << "),\n";
  ...
  cout << "trans(" << 0 << ",'0'/'0'," << 48*n-96+102 << "),\n";
  cout << "trans(" << 0 << ",'1'/'1'," << 48*n-96+102 << "),\n";
