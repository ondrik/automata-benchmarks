...
:- retract(pred_lang(PL)),fsa_regex_compile(file(prFM_g),P),assertz(pred_lang([P|PL])).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file(prFM_a),P),assertz(pred_lang([P|PL])).
