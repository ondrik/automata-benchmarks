...
accel_several_unwound_loops([[/,a],[/,b],[/,a,/,b]],States,MinAccelStates) :-
  do_accel_several_unwound_loops([[/,a],[/,b],[/,a,/,b]],States,AccelStates),
...
abstract(State,AbsState) :- accel_several_unwound_loops([[/,a],[/,b],[/,a,/,b]],State,AbsState).
