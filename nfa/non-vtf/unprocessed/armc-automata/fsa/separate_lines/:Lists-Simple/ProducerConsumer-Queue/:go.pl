...
septr_do_one_run_ph1(N,FromSt,ToLine,Tr,ITr,TrL,ReachedL,Result,Value) :-
  ...
  write('Source automaton: '),write(NS1),write(','),write(NT1),nl,
    ...
    tr(Tr,RealTr),
    fsa_regex_compile(mh(range(compose(fa(FromSt),fa(RealTr)))),ToSt),
...
septr_do_one_run_ph5(N,FromSt,ToLine,ToSt,ToAbSt,Tr,ITr,TrL,ReachedL,[ToErr,ToBackErr],Result,Value) :-
  ...
  write('Computing pre...'),nl,
    ...
    tr(ITr,RealITr),
    fsa_regex_compile(mh(range(compose(fa(ToErr),fa(RealITr)))),BackErr),
...
:- fsa_regex_compile(cleanup(file(tr_p1_0)),P1_0),
   ...
   fsa_regex_compile(cleanup(file(tr_p7_0)),P7_0),
     assertz(tr(tr_p7_0,P7_0)),
     fsa_regex_compile(inverse(fa(P7_0)),IP7_0),
     assertz(tr(itr_p7_0,IP7_0)),
   fsa_regex_compile(cleanup(file(tr_p8_0)),P8_0),
     assertz(tr(tr_p8_0,P8_0)),
     fsa_regex_compile(inverse(fa(P8_0)),IP8_0),
     assertz(tr(itr_p8_0,IP8_0)),
   fsa_regex_compile(cleanup(file(tr_p9_0)),P9_0),
     assertz(tr(tr_p9_0,P9_0)),
     fsa_regex_compile(inverse(fa(P9_0)),IP9_0),
     assertz(tr(itr_p9_0,IP9_0)),
   ...
   fsa_regex_compile(cleanup(file(tr_p6s_1)),P6s_1),
     assertz(tr(tr_p6s_1,P6s_1)),
     fsa_regex_compile(inverse(fa(P6s_1)),IP6s_1),
     assertz(tr(itr_p6s_1,IP6s_1)),
   fsa_regex_compile(cleanup(file(tr_p7_1)),P7_1),
     assertz(tr(tr_p7_1,P7_1)),
     fsa_regex_compile(inverse(fa(P7_1)),IP7_1),
     assertz(tr(itr_p7_1,IP7_1)),
   fsa_regex_compile(cleanup(file(tr_p8_1)),P8_1),
     assertz(tr(tr_p8_1,P8_1)),
     fsa_regex_compile(inverse(fa(P8_1)),IP8_1),
     assertz(tr(itr_p8_1,IP8_1)),
   fsa_regex_compile(cleanup(file(tr_p9_1)),P9_1),
     assertz(tr(tr_p9_1,P9_1)),
     fsa_regex_compile(inverse(fa(P9_1)),IP9_1),
     assertz(tr(itr_p9_1,IP9_1)),
   ...
   fsa_regex_compile(cleanup(file(tr_c8_0)),C8_0),
     assertz(tr(tr_c8_0,C8_0)),
     fsa_regex_compile(inverse(fa(C8_0)),IC8_0),
     assertz(tr(itr_c8_0,IC8_0)),
   fsa_regex_compile(cleanup(file(tr_c8d_0)),C8d_0),
     assertz(tr(tr_c8d_0,C8d_0)),
     fsa_regex_compile(inverse(fa(C8d_0)),IC8d_0),
     assertz(tr(itr_c8d_0,IC8d_0)),
   fsa_regex_compile(cleanup(file(tr_c9_0)),C9_0),
     assertz(tr(tr_c9_0,C9_0)),
     fsa_regex_compile(inverse(fa(C9_0)),IC9_0),
     assertz(tr(itr_c9_0,IC9_0)),
   ...
   fsa_regex_compile(cleanup(file(tr_c8_1)),C8_1),
     assertz(tr(tr_c8_1,C8_1)),
     fsa_regex_compile(inverse(fa(C8_1)),IC8_1),
     assertz(tr(itr_c8_1,IC8_1)),
   fsa_regex_compile(cleanup(file(tr_c8d_1)),C8d_1),
     assertz(tr(tr_c8d_1,C8d_1)),
     fsa_regex_compile(inverse(fa(C8d_1)),IC8d_1),
     assertz(tr(itr_c8d_1,IC8d_1)),
   fsa_regex_compile(cleanup(file(tr_c9_1)),C9_1),
     assertz(tr(tr_c9_1,C9_1)),
     fsa_regex_compile(inverse(fa(C9_1)),IC9_1),
     assertz(tr(itr_c9_1,IC9_1)),

   fsa_regex_compile(cleanup(file(trans_check_cnt)),Check),
   ...
   TrToL=[
          ...
          [e,tr_c7_0,itr_c7_0],
          [e,tr_c8_0,itr_c8_0],
           [e,tr_c8d_0,itr_c8d_0],
          [e,tr_c9_0,itr_c9_0]

         ],

   TrL=[[b1,TrToL],
        [p2,TrToL],[p2b,TrToL],[p3,TrToL],[p4,TrToL],[p5,TrToL],[p6,TrToL],[p7,TrToL],[p8,TrToL],[p9,TrToL],
        [c2,TrToL],[c3,TrToL],[c4,TrToL],[c5,TrToL],[c6,TrToL],[c7,TrToL],[c8,TrToL],[c9,TrToL],
...
:- [2,[/,'00','01','10','11',p1,p2,p2b,p3,p4,p5,p6,p7,p8,p9,c1,c2,c3,c4,c5,c6,c7,c8,c9]]=[StartUnwTimes,DtSymL],
