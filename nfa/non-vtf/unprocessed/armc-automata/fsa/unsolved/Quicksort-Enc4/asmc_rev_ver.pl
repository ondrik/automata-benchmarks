...
:- fsa_regex_compile(file(start),Init),assertz(bad(Init)).

%% :- fsa_regex_compile(file(start_2),Init),assertz(bad(Init)).

%% :- fsa_regex_compile(file(start_3),Init),assertz(init(Init)).

%%......................

:- fsa_regex_compile(file(trs),TR),assertz(itr(TR)).

%% :- fsa_regex_compile(file(trsi),TR),assertz(itr(TR)).

%%......................

:- fsa_regex_compile(file(bad_loop),BAD),assertz(init(BAD)).
...
:- retract(pred_lang(PL)),fsa_regex_compile(file('pr-trs'),P),assertz(pred_lang([P|PL])).

#endif

%%......................

%% :- retract(pred_lang(PL)),fsa_regex_compile(file(reachable_2),P),assertz(pred_lang([P|PL])).

%% :- retract(pred_lang(PL)),fsa_regex_compile(file(reachable_2),P),assertz(pred_lang([[P,[0]]|PL])).

%% :- retract(pred_lang(PL)),fsa_regex_compile(file(reachable_2_3_acc),P),assertz(pred_lang([P|PL])).

%% :- retract(pred_lang(PL)),fsa_regex_compile(file(reachable_2_3_acc),P),assertz(pred_lang([[P,[0]]|PL])).
...
:- sort([b,l1,l2,q0,q1,q2,q3,o,f,e,l,h,r,x],S),assertz(sigma(S)).
