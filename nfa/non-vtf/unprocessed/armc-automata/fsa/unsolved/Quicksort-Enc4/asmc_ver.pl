...
:- fsa_regex_compile(file(start),Init),assertz(init(Init)).

%% :- fsa_regex_compile(file(start_2),Init),assertz(init(Init)).
...
:- fsa_regex_compile(file(bad_loop),BAD),assertz(bad(BAD)).
