...
do_one_run(N,AbsReach,Result,Value) :-
  ...
  fsa_regex_compile(mb(range(compose(fa(AbsReach),fa(TR)))),NewReachAux),
  fsa_regex_atom_compile('{?,[]: \'_b\', \'_b\':[]}*',TrRePad),
  fsa_regex_compile(mb(range(compose(fa(NewReachAux),fa(TrRePad)))),NewReach),
...
:- fsa_regex_compile(file(init_lpr),Init),assertz(init(Init)).

%% :- fsa_regex_compile(file('init-1_prod_1_cons_lpr'),Init),assertz(init(Init)).

%%......................

:- fsa_regex_compile(file(trs_lpr),TR),assertz(tr(TR)).

%%......................

:- fsa_regex_compile(file(bad_lpr),BAD),assertz(bad(BAD)).
...
:- sort(['_b',!,#,/,'|','_f','_t',n,s,su,e,u,d,c,l,h,t,x,lock,unlock,
...
:- [2,['_b',/,'00','01','10','11',p1,p2,p2b,p3,p4,p5,p6,p7,p8,p9,c1,c2,c3,c4,c5,c6,c7,c8,c9]]=[StartUnwTimes,DtSymL],
