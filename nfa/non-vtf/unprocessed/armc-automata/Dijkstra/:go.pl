...
fl_comp_new_reach(ReachClL,ReachL,AllReachL1,AllReachL2) :-
  maplist(fl_take_fst,ReachClL,ReachL),
  ord_union(AllReachL1,ReachL,AllReachL2).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

fl_comp_new_classes(QN,ReachQL,SigL,TrL,OldClL,NewReachL,NewClassL,AllReachL1,AllReachL2) :-
  ...
  fl_comp_new_reach(ReachClL,NewReachL,AllReachL1,AllReachL2),
  !.
...
%%% An optimization - we stop sooner than at Lim when AllReachL1=AllReachL2 and OldClL=NewClL...

fl_comp_classes(N,Lim,QN,ReachQL,SigL,TrL,OldClL,ClL,AllReachL1,AllReachL3) :-
  N<Lim,
  !,
  NN is N+1,
  fl_comp_new_classes(QN,ReachQL,SigL,TrL,OldClL,NewReachQL,NewClL,AllReachL1,AllReachL2),
  ( (ReachQL=NewReachQL,OldClL=NewClL, !, ClL=NewClL,AllReachL3=AllReachL2);
    %% (AllReachL1=AllReachL2,OldClL=NewClL, !, ClL=NewClL,AllReachL3=AllReachL2);
    (fl_comp_classes(NN,Lim,QN,NewReachQL,SigL,TrL,NewClL,ClL,AllReachL2,AllReachL3)) ),
  !.

fl_comp_classes(Lim,Lim,_,_,_,_,ClL,ClL,AllReachL,AllReachL).
...
fl_comp_partition(N,QN,FL,TrL,PartL) :-
  ...
  fl_comp_classes(0,N,QN,FL,SigL,TrL,[[0,FL],[1,NonFL]],ClL,FL,_),
...
abstr_fl_refby_ft(Conc,Abstr) :-
  ...
  fl_comp_classes(0,Lim,ConcQN,ConcFinL,SigL,ConcTrL,[[0,ConcFinL],[1,NonFL]],ClL1,ConcFinL,AllReachL),
  ...
  fl_comp_classes(0,N,ConcQN,QL,SigL,ConcTrL,ClL1,ClL2,QL,_),
